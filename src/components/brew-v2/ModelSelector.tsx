  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="bg-transparent text-[length:var(--fs-sm)] text-muted-foreground border border-border rounded px-1.5 py-0.5 cursor-pointer hover:border-foreground/30 focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-100 appearance-none pr-5 transition-colors"
        style={{
