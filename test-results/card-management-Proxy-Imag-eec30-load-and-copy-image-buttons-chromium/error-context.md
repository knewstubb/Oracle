...
- Name: card-management.spec.ts >> Proxy Image Actions >> proxy card popover shows download and copy image buttons
- Location: tests/e2e/card-management.spec.ts:464:7
