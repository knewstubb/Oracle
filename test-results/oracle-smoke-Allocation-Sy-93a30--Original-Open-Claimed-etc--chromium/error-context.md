...
- Name: oracle-smoke.spec.ts >> Allocation System >> card statuses load for a deck (Original, Open, Claimed, etc.)
- Location: tests/e2e/oracle-smoke.spec.ts:408:7
...
Locator: getByText(/Original —|Proxy —|Open —/).first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText(/Original —|Proxy —|Open —/).first()
