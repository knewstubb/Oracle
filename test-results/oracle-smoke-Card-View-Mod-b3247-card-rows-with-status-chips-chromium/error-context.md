...
- Name: oracle-smoke.spec.ts >> Card View Modes >> list view shows card rows with status chips
- Location: tests/e2e/oracle-smoke.spec.ts:476:7
...
Locator: getByRole('radio', { name: /list view/i })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('radio', { name: /list view/i })
