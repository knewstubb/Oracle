...
- Name: oracle-smoke.spec.ts >> Card View Modes >> cards view shows card images in a grid
- Location: tests/e2e/oracle-smoke.spec.ts:489:7
...
Locator: getByRole('radio', { name: /cards view/i })
Expected: visible
Timeout: 15000ms
